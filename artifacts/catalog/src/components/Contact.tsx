    ...
    <section id="contact" className="scroll-mt-20 py-24 px-4 bg-white border-t border-border">
      <div className="container mx-auto max-w-3xl text-center">
        ...
        <div className="flex flex-row justify-center gap-10 mb-12">
          ...
          >
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-neutral-900 border border-neutral-800 transition-all duration-200 group-hover:bg-neutral-700 group-hover:shadow-lg">
            ...
            <div className="flex flex-col items-center gap-0.5">
              <span className="text-sm font-medium text-foreground">{t("contactModalEmail")}</span>
              <span className="text-xs text-muted-foreground">2day0nly26@gmail.com</span>
            </div>
          </a>
          ...
          >
            ...
            <div className="flex flex-col items-center gap-0.5">
              <span className="text-sm font-medium text-foreground">{t("contactModalWhatsApp")}</span>
              <span className="text-xs text-muted-foreground">+371 25784274</span>
            </div>
          </a>
        </div>
